...
class Specialite extends \App\Entity\Specialite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Specialite' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Specialite' . "\0" . 'designation'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDesignation(string $designation): \App\Entity\Specialite
    {
